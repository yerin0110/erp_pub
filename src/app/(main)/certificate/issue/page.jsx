                    ...
                    <div className={c.issueBox}>
                        ...
                        <div className={c.applyContent}>
                            ...
                            <div className={c.applyInfoBox}>
                                ...
                                <div className={c.infoUser}>
                                    <div className={c.applyInfo}>
                                        <span>용도<p className={c.necessary}>*</p></span>
                                    ...
                                    <div className={c.applyInfo}>
                                        <span>제출처<p className={c.necessary}>*</p></span>
                                        <input type="text"
                                    ...
                                    <div className={c.applyInfo}>
                                        <span>발급부수<p className={c.necessary}>*</p></span>
                                    ...
                                    <div className={c.applyInfo}>
                                        <span>언어선택<p className={c.necessary}>*</p></span>
                                ...
                                <div className={c.previewBox}>
                                    <div className={c.previewTextBox}>
                                        ...
                                        <div className={c.previewText}>
                                            ...
                                            <span>발급된 증명서는 위변조 방지 마크가 포함됩니다. 내용을 반드시 확인한 우 출력해 주세요.</span>
                                        </div>
                                    </div>
