          ...
          <div className={c.apply}>
            <div className={c.applyBox}>
              <div className={c.applyTitle}>
                ...
                <p>
                  <span className={c.necessary}>*</span>필수항목
                </p>
              </div>
              <div className={c.breakApply}>
                ...
                <div className={c.applyInfo}>
                  <label>
                    휴가 종류<span className={c.necessary}>*</span>
                  </label>
                  <div className={c.typeBox}>
                    <button className={c.dayoff}>
                      <CalendarCheck size={13} color="#ffffff" />
                      연차
                    </button>
                ...
                <div className={c.applyInfo}>
                  <label>
                    휴가 기간<span className={c.necessary}>*</span>
                  </label>
                ...
                <div className={c.applyInfo}>
                  <label>
                    업무 대리자 <span className={c.optional}>선택사항</span>
                  </label>
                ...
                <div className={c.applyInfo}>
                  <label>
                    휴가 사유 <span className={c.necessary}>*</span>
                  </label>
                  <textarea
                    name=""
                    id=""
                ...
                <div className={c.applyInfo}>
                  <label>
                    첨부파일{" "}
                    <span className={c.optional}>선택사항 · 최대 3개</span>
                  </label>
                ...
                <div className={c.btnBox}>
                  ...
                  <button className={c.applyBtn}>
                    <SendHorizontal size={13} color="#ffffff" />
                    신청하기
                  </button>
                </div>
              </div>
            ...
            <div className={c.applyContent}>
              ...
              <div className={c.historyBox}>
                ...
                <div className={c.history}>신청이력이지롱</div>
              </div>
            </div>
          </div>
        </div>
